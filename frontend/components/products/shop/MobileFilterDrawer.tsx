...
export default function MobileFilterDrawer({
  ...
  return (
    <div
      className="fixed inset-0 z-50 lg:hidden bg-slate-900/60 backdrop-blur-xs transition-opacity"
      role="dialog"
      aria-modal="true"
    ...
    >
      ...
      {/* Drawer Panel */}
      <div className="relative ml-auto w-4/5 max-w-xs h-full bg-white shadow-2xl flex flex-col z-10 overflow-y-auto">
        {/* Drawer Header */}
        <div className="p-4 border-b border-gray-100 flex items-center justify-between">
          <h2 className="text-lg font-bold text-gray-900">Filter &amp; Sort</h2>
          <button
            onClick={onClose}
            className="p-2 text-gray-500 hover:text-gray-900 rounded-lg focus-visible:outline-2 focus-visible:outline-[#01A7E5]"
        ...
        <div className="p-4 border-t border-gray-100 bg-gray-50 flex gap-3">
          <button
            ...
            className="flex-1 py-2.5 rounded-xl border border-gray-300 text-sm font-semibold text-gray-700 hover:bg-gray-100 transition-colors"
          >
            Reset
          </button>
          <button
            onClick={onClose}
            className="flex-1 py-2.5 rounded-xl bg-[#01A7E5] text-white text-sm font-semibold hover:bg-[#018bc0] transition-colors"
          >
            Apply
          </button>
        </div>
