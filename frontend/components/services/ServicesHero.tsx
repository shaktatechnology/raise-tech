  ...
  return (
    <section className="relative w-full h-[320px] sm:h-[420px] md:h-[500px] lg:h-[560px] overflow-hidden bg-[#022c43]">
      ...
      <Image
        ...
        alt="Raise Tech Technology Services Banner"
        fill
        priority
        className="object-cover object-center"
      />

      {/* Cyan/Blue Gradient Overlay matching design */}
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-full flex flex-col justify-center items-center text-center">
        ...
        <p className="mt-4 text-base sm:text-lg md:text-xl text-cyan-50 max-w-2xl font-medium">
          Comprehensive IT &amp; Software Solutions Designed to Scale Your Enterprise
        </p>
      </div>
    </section>
  );
