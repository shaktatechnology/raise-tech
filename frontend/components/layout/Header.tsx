...
export default function Header() {
  ...
  return (
    <>
      <header role="banner" className="sticky top-0 z-40 bg-white/95 backdrop-blur-md shadow-xs border-b border-gray-100 transition-all duration-300">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16 sm:h-20 px-0 sm:px-2">
            ...
            <Link href="/" className="flex items-center gap-3 group focus-visible:outline-2 focus-visible:outline-[#01A7E5]">
              <div className="relative h-8 sm:h-9 max-w-[170px] flex items-center shrink-0 transition-transform duration-200 group-hover:scale-[1.02]">
                {settings?.logo ? (
                  ...
                  if (link.dropdown) {
                    return (
                      ...
                      >
                        ...
                        {/* Dropdown Menu with motion animation */}
                        <AnimatePresence>
                          {dropdownOpen && (
                            <motion.div
                              ...
                              onMouseLeave={handleMouseLeaveDropdown}
                            >
                              <div className="bg-white rounded-xl shadow-xl border border-gray-100 py-1.5 z-50 overflow-hidden">
                                  ...
                                  return (
                                    <Link
                                      ...
                                      className={`flex items-center gap-2 px-4 py-3 text-sm font-semibold transition-colors ${
                                        index < link.dropdown!.length - 1 ? 'border-b border-gray-100' : ''
                                      } ${
                                        isSubActive
                                    ...
                                    >
                                      <span className="text-[#01A7E5] font-extrabold text-sm transition-transform duration-150 group-hover:translate-x-0.5">»</span>
              ...
              <div className="flex items-center gap-3">
                <div className="relative" id="header-cart-button">
                  <motion.button
                    ...
                    whileTap={{ scale: 0.95 }}
                    className="relative p-2.5 text-gray-700 hover:text-[#01A7E5] transition-colors duration-200 focus-visible:outline-2 focus-visible:outline-[#01A7E5] rounded-full hover:bg-gray-50 cursor-pointer"
                  ...
                  >
                    ...
                    {totalItems > 0 && (
                      <motion.span
                        ...
                        className="absolute -top-0.5 -right-0.5 bg-[#01A7E5] text-white text-xs font-bold w-5 h-5 rounded-full flex items-center justify-center shadow-xs"
                      >
                        {totalItems}
                      </motion.span>
                    )}
                ...
                {user ? (
                  <div className="flex items-center gap-2">
                    ...
                    <button
                      onClick={logout}
                      className="px-3.5 py-1.5 bg-gray-100 hover:bg-gray-200 text-gray-700 font-semibold text-xs rounded-lg transition-all duration-200 transform hover:-translate-y-0.5 cursor-pointer"
                    >
                      Logout
                    </button>
                  </div>
                  ...
                  <motion.button
                    ...
                    whileTap={{ scale: 0.98 }}
                    className="px-4 py-2 bg-[#01A7E5] hover:bg-[#018bc0] text-white text-xs font-bold rounded-xl shadow-2xs hover:shadow-md transition-colors cursor-pointer"
                  >
                    Sign In
                  </motion.button>
                )}
            ...
            <div className="flex items-center gap-2 md:hidden">
              ...
              <button
                ...
                className="p-2 text-gray-700 hover:text-[#01A7E5] rounded-lg hover:bg-gray-50 focus-visible:outline-2 focus-visible:outline-[#01A7E5] cursor-pointer"
