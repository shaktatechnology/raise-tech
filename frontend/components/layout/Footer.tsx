    ...
    <footer className="bg-white text-[#404040] border-t border-gray-100 pt-16 pb-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 pb-12 border-b border-gray-200/80">
          ...
          <div>
            <h3 className="text-base font-bold text-[#01A7E5] mb-4">Quick Links</h3>
            <ul className="space-y-2.5 text-xs font-medium text-gray-600">
              ...
              <li>
                <Link href="/about" className="hover:text-[#01A7E5] transition-colors">About</Link>
              </li>
              <li>
                <Link href="/services" className="hover:text-[#01A7E5] transition-colors">Services</Link>
              </li>
              <li>
                <Link href="/products" className="hover:text-[#01A7E5] transition-colors">Our Products</Link>
              </li>
              <li>
                <Link href="/contact" className="hover:text-[#01A7E5] transition-colors">Contact</Link>
              </li>
            </ul>
          </div>
          ...
          <div>
            <h3 className="text-base font-bold text-[#01A7E5] mb-4">Contact Details</h3>
          ...
          <div>
            <h3 className="text-base font-bold text-[#01A7E5] mb-2">Stay Connected</h3>
            ...
            {subscribed ? (
              ...
              <form onSubmit={handleSubscribe} className="space-y-2.5">
                ...
                >
                  <span>Submit</span>
                  <svg className="w-3.5 h-3.5 transform rotate-45" fill="currentColor" viewBox="0 0 20 20">
