        ...
        <div className="pt-6 flex flex-col sm:flex-row items-center justify-between text-xs text-gray-400 gap-4">
          ...
          <div className="flex items-center gap-3">
            <motion.a
              ...
              className="w-8 h-8 rounded-full border border-gray-200 bg-gray-50/50 flex items-center justify-center text-gray-600 hover:border-[#01A7E5] hover:bg-[#01A7E5] hover:text-white transition-colors shadow-2xs"
              aria-label="Facebook"
            >
            ...
            <motion.a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="w-8 h-8 rounded-full border border-gray-200 bg-gray-50/50 flex items-center justify-center text-gray-600 hover:border-pink-500 hover:bg-gradient-to-tr hover:from-amber-500 hover:via-pink-500 hover:to-purple-600 hover:text-white transition-colors shadow-2xs"
            ...
            <motion.a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="w-8 h-8 rounded-full border border-gray-200 bg-gray-50/50 flex items-center justify-center text-gray-600 hover:border-black hover:bg-black hover:text-white transition-colors shadow-2xs"
              aria-label="Twitter"
            >
              <svg className="w-3.5 h-3.5 fill-current" viewBox="0 0 24 24">
