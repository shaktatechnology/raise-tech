          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 pb-12 border-b border-gray-200/80">
            ...
            <div className="space-y-4">
              <Link href="/" className="flex items-center gap-3 group inline-block">
                <div className="relative h-10 max-w-[200px] flex items-center shrink-0 transition-transform duration-200 group-hover:scale-[1.02]">
                  {settings?.logo ? (
              ...
              <ul className="space-y-2.5 text-xs font-medium text-gray-600">
                {[
                  ...
                  <li key={item.href}>
                    <Link
                      href={item.href}
                      className="inline-block hover:text-[#01A7E5] hover:translate-x-1 transition-all duration-200"
                    >
                      {item.label}
                    </Link>
                  </li>
            ...
            <div>
              ...
              <ul className="space-y-3.5 text-xs text-gray-600">
                <li className="flex items-center gap-3">
                  <div className="w-6 h-6 rounded-full bg-[#01A7E5] flex items-center justify-center text-white shrink-0 shadow-2xs">
                    <svg
                      className="w-3 h-3"
                      fill="none"
                      stroke="currentColor"
            ...
            <div className="space-y-3">
              ...
              <div className="pt-1 space-y-2">
                <Link
                  href="/contact"
                  className="w-full bg-[#01A7E5] hover:bg-[#018bc0] text-white text-xs font-semibold py-2.5 px-4 rounded-lg transition-all duration-200 flex items-center justify-center gap-2 shadow-xs hover:shadow-md transform hover:-translate-y-0.5"
                >
                ...
                {settings?.whatsapp_url && (
                  <a
                    ...
                    className="w-full bg-emerald-600 hover:bg-emerald-500 text-white text-xs font-semibold py-2 px-4 rounded-lg transition-all duration-200 flex items-center justify-center gap-2 shadow-xs hover:shadow-md transform hover:-translate-y-0.5"
                  >
