    ...
    <section className="py-20 bg-[#f7fdff] text-[#404040] overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
                  ...
                  >
                    <motion.div
                      ...
                      className={`relative aspect-[3/4] rounded-2xl overflow-hidden cursor-pointer shadow-md transition-all duration-300 group ${
                        isActive
                          ? 'ring-4 ring-emerald-500 shadow-xl scale-[1.02]'
          ...
          <Reveal variant="slideRight" className="lg:col-span-5 space-y-4 text-left">
            ...
            <div className="pt-2">
              <Link
                href="/portfolio"
                className="inline-flex items-center gap-2 px-6 py-3 bg-emerald-600 hover:bg-emerald-700 text-white font-bold text-sm rounded-xl shadow-xs transition-all duration-300 transform hover:-translate-y-0.5 hover:shadow-md"
              >
