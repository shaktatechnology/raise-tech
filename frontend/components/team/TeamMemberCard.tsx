...
export default function TeamMemberCard({ member }: TeamMemberCardProps) {
  return (
    <div className="flex flex-col lg:flex-row items-center justify-center w-full max-w-lg lg:max-w-none mx-auto group">
      ...
      <div className="w-full lg:w-[335px] min-h-[280px] lg:min-h-[305px] bg-white rounded-xl shadow-[0px_4px_15px_0px_rgba(0,0,0,0.12)] p-6 sm:p-7 flex flex-col justify-between -mt-8 lg:mt-0 lg:-ml-12 z-10 border border-gray-100/80 transition-shadow duration-300 hover:shadow-lg">
        <div>
          {/* Member Name */}
        ...
        <div className="mt-5 pt-3 flex items-center gap-4">
          ...
          {member.socialLinks?.facebook ? (
            <a
              ...
              className="p-1.5 text-[#01A7E5] hover:text-[#0180b0] transition-colors focus-visible:outline-2 focus-visible:outline-[#01A7E5] rounded-md"
            >
