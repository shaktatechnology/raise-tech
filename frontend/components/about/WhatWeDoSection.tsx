...
interface WhatWeDoSectionProps {
  items?: WhatWeDoApiItem[];
  teamImage?: string | null;
}

export default function WhatWeDoSection({ items, teamImage }: WhatWeDoSectionProps) {
  const displayItems = items && items.length > 0 ? items : WHAT_WE_DO_ITEMS;
                  ...
                  >
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <div
                          className="text-cyan-50 text-sm sm:text-base italic leading-relaxed text-justify [&_p]:m-0 [&_p]:inline"
