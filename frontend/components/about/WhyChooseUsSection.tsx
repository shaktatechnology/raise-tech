          ...
          {displayItems.map((card, idx) => {
            ...
            return (
              <StaggerItem key={card.id}>
                <div
                  className={`group flex flex-col justify-between h-full p-6 rounded-2xl transition-all duration-300 transform hover:-translate-y-1.5 shadow-md hover:shadow-xl border ${
                    isBlue
                ...
                >
                  ...
                  <div className="pt-6">
                    <Link
                      href={card.ctaHref}
                      className={`inline-flex items-center justify-center gap-1.5 px-6 py-2.5 rounded-full text-sm font-semibold transition-all duration-300 shadow-sm transform hover:scale-[1.02] active:scale-[0.98] focus-visible:outline-2 focus-visible:outline-[#01a7e5] ${
                        isBlue
